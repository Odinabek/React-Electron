    ...
    <div className="bodyHome">
      <section className="layers">
        <div className="layers__container">
          ...
          <div className="layers__item layers-2">
            <img src={layer2}></img>
          </div>
          <div className="layers__item layer-3">
            <div className={modalActive ? "hero-n" : "hero-content"}>
              <div className={open ? "box-btn" : "box-btn-true"}>
                <button
                  ...
                  onClick={() => setOpen(true) || setClcState("Html")}
                >
                  HTML
                </button>{" "}
                <br />
                <button
                  className="button-categories"
                  onClick={() => setOpen(true) || setClcState("Css")}
                >
                  Css
                </button>{" "}
                <br />
                <button
                  className="button-categories"
                  onClick={() => setOpen(true) || setClcState("Js")}
                >
                  JS
                </button>{" "}
                <br />
                <button className="button-categories">React</button> <br />
                <button className="button-categories">React Native</button>{" "}
                <br />
                <button className="button-categories">Electron js</button>
                <br />
                <button className="button-categories">node js</button> <br />
                <button className="button-categories">sql</button>
                <br />
                <button className="button-categories">psql</button> <br />
                <button
                  className="button-categories"
                  onClick={() => setModalActive(true) || setOpen(false)}
                >
                  Меню
                </button>{" "}
                <br />
            ...
            <div className={open ? "content-open" : "content-n"}>
              <button className="button-esc" onClick={() => setOpen(false)}>
                x
              </button>{" "}
              <br />
